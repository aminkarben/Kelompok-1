...
const SearchMovies = () => {
    ...
    const { searchedMovies, totalPages, totalResult, isLoading } = useSelector(
        (state) => state.search
    );
    ...
    return (
        <>
            ...
            <div className="d-flex justify-content-center mt-3 mb-0 text-light">
                Page &quot;{pageValue}&quot; out of {totalPages}
            </div>
        </>
    );
};
